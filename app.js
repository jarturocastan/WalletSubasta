...
const contractSubastaAddress = '0x53a40b887d4629b34e1975295a197b0bb2419e88'
	...
	const privateKey1 = Buffer.from(creadentials.key, 'hex')
		  ...
		  web3.eth.getTransactionCount(creadentials.account, (err, txCount) => {
			...
			const txObject = {
			  ...
			  to: contractAddress,
			  value:1,
			  data: contract.methods.transferFrom("0x61b69860C334579Fc61903766bC79e7BD584bE51",creadentials.account,1).encodeABI()
			 // data: contractSubasta.methods.sellToken(1).encodeABI()
			}
